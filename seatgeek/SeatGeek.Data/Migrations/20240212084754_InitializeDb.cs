        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2024, 2, 12, 8, 47, 54, 203, DateTimeKind.Utc).AddTicks(5722)),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategoryEvents", x => new { x.ChildCategoryId, x.EventId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Quantity = table.Column<int>(type: "int", maxLength: 10000, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    EventTicketsId = table.Column<int>(type: "int", nullable: false),
                    TicketOwnersId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationUserTicket", x => new { x.EventTicketsId, x.TicketOwnersId });
                    table.ForeignKey(
                        name: "FK_ApplicationUserTicket_AspNetUsers_TicketOwnersId",
                        column: x => x.TicketOwnersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ApplicationUserTicket_Tickets_EventTicketsId",
                        column: x => x.EventTicketsId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationUserTicket_TicketOwnersId",
                table: "ApplicationUserTicket",
                column: "TicketOwnersId");
